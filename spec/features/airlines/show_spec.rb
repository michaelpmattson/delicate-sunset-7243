...
RSpec.describe 'airline show page' do
  ...
  context 'frequent flyers' do
    ...
    it 'sorts the list of passengers by frequent flights most to least' do
      expect(@marcia.name).to appear_before(@mike.name)
      expect(@mike.name).to appear_before(@carol.name)
    end
  end
end
